...
deploy_realm() {
    ...
    # 下载最新版本
    DOWNLOAD_URL="https://github.makkle.com/https://github.com/zhboner/realm/releases/download/v${LATEST_VERSION}/realm-x86_64-unknown-linux-gnu.tar.gz"
...
main_menu() {
    ...
    while true; do
        ...
        echo -e "        或者 wget -N https://github.makkle.com/https://raw.githubusercontent.com/qqrrooty/EZrealm/main/realm-2025.sh && chmod +x realm.sh && ./realm.sh"
